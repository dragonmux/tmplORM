		...
		testOctToUint64(*this,
			{
				...
				{UINT64_C(9223372036854775808), "1000000000000000000000"},
				{UINT64_C(18446744073709551615), "1777777777777777777777"}
			}
		);
	}
		...
		testOctToInt64(*this,
			{
				...
				{INT64_C(-9223372036854775808), "1000000000000000000000"}
			}
		);
	}
